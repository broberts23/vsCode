...
Creates: resource group, Foundry project, deepseek-v4-flash serverless deployment, Container Registry, Log Analytics, Application Insights, per-agent managed identity with Foundry User role.
