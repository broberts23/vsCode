...
1. Emergency or hotfix changes in production
...
1. Secrets, certificate, or key rotation tasks
...
1. High-impact configuration changes
...
1. Onboard/offboard flows that require temporary promotion
...
1. Incident-response diagnostics and remediation
...
1. Governance and testing of access‑review flows
...
1. Multi-tenant or partner delegated operations
...
1. Identity configuration changes
...
1. Scheduled maintenance and controlled windows
...
1. CI job starts and validates context
...
1. Prepare activation context programmatically
...
1. Rotate the secret (performed under the JIT activation)
